package com.edge.currency.processOperation.processImage.entiy;
		...
		for (HistoricActivityInstance historicActivityInstance : activityInstances) {
			...
			if (activity != null) {
				if (historicActivityInstance.getEndTime() == null) {
					// 节点正在运行中
					signRunningNode(image, activity.getX(), activity.getY(), activity.getWidth(), activity.getHeight(),
					...
					if ("跳过".equals(deleteReason)) {
						...
						signHistoryNode(image, activity.getX(), activity.getY(), activity.getWidth(),
								activity.getHeight(), historicActivityInstance.getActivityType());
					}
				}
			}
		}
