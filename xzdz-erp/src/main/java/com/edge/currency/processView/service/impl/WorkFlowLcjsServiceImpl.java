package com.edge.currency.processView.service.impl;
...
import com.edge.currency.processView.dao.WorkFlowLcjsDao;
 ...
 */
@Service
public class WorkFlowLcjsServiceImpl implements WorkFlowLcjsService {

	@Resource
	private WorkFlowLcjsDao workFlowLcjsDao;
	...
	public void saveLcjs(Sys_WorkFlow_Lcjs lcjs) {
		workFlowLcjsDao.saveLcjs(lcjs);
	}

	// 编辑流程检视
	public void editLcjs(Sys_WorkFlow_Lcjs lcjs) {
		workFlowLcjsDao.editLcjs(lcjs);
	}

	// 根据ObjId展现流程检视数据
	public List<Sys_WorkFlow_Lcjs> lcjsList(String objId) {
		return workFlowLcjsDao.lcjsList(objId);
	}
...
//          }
	...
	public Sys_WorkFlow_Lcjs queryLcjsByInfor(String objId, String nodeName) {
		return workFlowLcjsDao.queryLcjsByInfor(objId, nodeName);
	}
