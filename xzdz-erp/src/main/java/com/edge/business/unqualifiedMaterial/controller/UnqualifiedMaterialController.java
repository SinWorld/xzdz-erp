 ...
 */
@Controller
@RequestMapping(value = "unqualifiedMaterial")
public class UnqualifiedMaterialController {
	...
	// 跳转至不合格材料反馈界面
	@RequestMapping(value = "/initUnqualifiedMaterial.do")
	public String initUnqualifiedMaterial(@RequestParam String objId, String taskId, Model model) {
		// 得到销售合同Id
		...
		return "business/unqualifiedMaterial/saveUnqualifiedMaterial";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/submit.do")
	public String submit(@RequestParam String advice, String taskId, Model model, HttpServletRequest request) {
		/**
