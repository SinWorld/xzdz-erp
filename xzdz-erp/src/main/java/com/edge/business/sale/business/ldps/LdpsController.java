package com.edge.business.sale.business.ldps;
...
public class LdpsController {
	...
	// 跳转至领导评审页面
	@RequestMapping(value = "/initLdps.do")
	public String initLdps(@RequestParam String objId, String taskId, Model model) {
		String xsddId = objId.substring(objId.indexOf(".") + 1);
		model.addAttribute("xsddId", xsddId);
		model.addAttribute("taskId", taskId);
		return "business/sale/business/ldps/saveLdps";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/ldps.do")
	public String ldps(@RequestParam String task_Id, String out_come, String advice_, HttpServletRequest request,
			Model model) {
