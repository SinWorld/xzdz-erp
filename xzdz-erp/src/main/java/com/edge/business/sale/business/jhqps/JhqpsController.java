package com.edge.business.sale.business.jhqps;
 ...
 */
@Controller
@RequestMapping(value = "jhqps")
public class JhqpsController {
	...
	// 跳转至价格评审
	@RequestMapping(value = "/initJhqps.do")
	public String initJhqps(@RequestParam String objId, String taskId, Model model) {
		String xsddId = objId.substring(objId.indexOf(".") + 1);
		model.addAttribute("xsddId", xsddId);
		model.addAttribute("taskId", taskId);
		return "business/sale/business/jgps/saveJgps";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/jhqps.do")
	public String jhqps(@RequestParam String task_Id, String out_come, String advice_, HttpServletRequest request,
			Model model) {
