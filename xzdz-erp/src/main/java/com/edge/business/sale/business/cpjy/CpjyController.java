package com.edge.business.sale.business.cpjy;
 ...
 */
@Controller
@RequestMapping(value = "cpjy")
public class CpjyController {
	...
	// 跳转至产品检验页面
	@RequestMapping(value = "/initCpjy.do")
	public String initCpjy(@RequestParam String objId, String taskId, Model model) {
		String xsddId = objId.substring(objId.indexOf(".") + 1);
		model.addAttribute("xsddId", xsddId);
		model.addAttribute("taskId", taskId);
		return "business/sale/business/cpjy/saveCpjy";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/cpjy.do")
	public String cpjy(@RequestParam String task_Id, String out_come, String advice_, HttpServletRequest request,
			Model model) {
