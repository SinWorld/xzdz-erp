package com.edge.business.sale.business.jgps;
 ...
 */
@Controller
@RequestMapping(value = "jgps")
public class JgpsController {
	...
	// 跳转至价格评审
	@RequestMapping(value = "/initJgps.do")
	public String initJgps(@RequestParam String objId, String taskId, Model model) {
	...
	// 提交表单推动流程
	@RequestMapping(value = "/jgps.do")
	public String jgps(@RequestParam String task_Id, String out_come, String advice_, HttpServletRequest request,
			Model model) {
