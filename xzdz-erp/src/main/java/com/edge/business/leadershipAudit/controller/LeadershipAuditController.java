...
public class LeadershipAuditController {
	...
	// 提交表单推动流程
	@RequestMapping(value = "/leadershipAudit.do")
	public String leadershipAudit(@RequestParam String task_Id, String out_come, String advice_,
	...
	// 跳转至领导审核页面
	@RequestMapping(value = "/initEditLeadershipAudit.do")
	public String initEditLeadershipAudit(@RequestParam String objId, String taskId, Model model) {
		model.addAttribute("objId", objId);
		model.addAttribute("taskId", taskId);
		return "business/leadershipAudit/leadershipAudit";
	}
