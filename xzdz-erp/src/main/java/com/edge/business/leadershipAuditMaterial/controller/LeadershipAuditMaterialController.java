package com.edge.business.leadershipAuditMaterial.controller;
 ...
 */
@Controller
@RequestMapping(value = "leadershipAuditMaterial")
public class LeadershipAuditMaterialController {
	...
	@RequestMapping(value = "/initLeadershipAuditMaterial")
	public String initLeadershipAuditMaterial(@RequestParam String objId, String taskId, Model model) {
		// 得到销售合同Id
		...
		return "business/leadershipAuditMaterial/saveLeadershipAuditMaterial";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/leadershipAuditMaterial.do")
	public String leadershipAuditMaterial(@RequestParam String task_Id, String out_come, String advice_,
