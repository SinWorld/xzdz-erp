 ...
 */
@Controller
@RequestMapping(value = "cghtfk_cwsp")
public class CwspController {
	...
	// 跳转至财务审批页面
	@RequestMapping(value = "/initCwsp.do")
	public String initCwsp(@RequestParam String objId, String taskId, Model model) {
		String cghtfkdm = objId.substring(objId.indexOf(".") + 1);
		model.addAttribute("cghtfkdm", cghtfkdm);
		model.addAttribute("taskId", taskId);
		return "cghtfk/saveCwsp";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/saveCwsp.do")
