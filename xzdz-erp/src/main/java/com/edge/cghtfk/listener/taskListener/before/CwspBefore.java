package com.edge.cghtfk.listener.taskListener.before;
...
/**
 * 财务审批操作之前，用于设置该节点任务的办理人,设置流程检视
 * 
 * @author NingCG
 *
 */
@Alias("cghtsk_cwspBefore")
public class CwspBefore implements TaskListener {
