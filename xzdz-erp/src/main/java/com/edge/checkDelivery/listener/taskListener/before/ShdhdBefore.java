package com.edge.checkDelivery.listener.taskListener.before;
...
/**
 * 送货单核对作之前,用于设置该节点的任务办理人
 * 
 * @author NingCG
 *
 */
@Alias("checkDelivery_shdhd")
public class ShdhdBefore implements TaskListener {
