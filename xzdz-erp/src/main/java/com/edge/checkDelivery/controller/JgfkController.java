 ...
 */
@Controller
@RequestMapping(value = "jgfk")
public class JgfkController {
	...
	// 跳转至结果反馈页面
	@RequestMapping(value = "/initJgfk.do")
	public String initShdsh(@RequestParam String objId, String taskId, Model model) {
		String rowId = objId.substring(objId.indexOf(".") + 1);
		model.addAttribute("rowId", rowId);
		model.addAttribute("taskId", taskId);
		return "checkDelivery/savejgfk";
	}

	// 提交表单推动流程
	@RequestMapping(value = "/savejgfk.do")
	public String savejgfk(@RequestParam String task_Id, Integer row_Id, String fksm, HttpServletRequest request,
			Model model) {
