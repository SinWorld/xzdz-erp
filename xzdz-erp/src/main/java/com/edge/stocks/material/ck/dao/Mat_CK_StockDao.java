...
public interface Mat_CK_StockDao {
	// 分页展现材料库存
	public List<ERP_Material_Stock> mat_CK_StockList(@Param("ERP_MatStock_QueryVo")ERP_MatStock_QueryVo vo);

	// 材料库存数量
	public Integer matCKStockCount(@Param("ERP_MatStock_QueryVo")ERP_MatStock_QueryVo vo);
