...
<body style="width:100%;padding:0px; margin:0px;text-align: center;" onload="refreshAndClose()">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/proStock/editStock.do"/>' method="post">
		...
		<input type="hidden" name="stock_Id" value="${stock.stock_Id}">
		 	...
		 	<div class="layui-form-item" style="margin-top: 50px;">
				<div class="layui-inline" style="top:9px;left:-445px;">
			      ...
			      <div class="layui-input-inline">
			        <input type="text" name="stock" id="stock" lay-verify="stock" autocomplete="off" class="layui-input" style="width: 800px;" onchange="checkKw()" value="${stock.stock}">
			      </div>
				 </div>
			</div>
			 ...
			 <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea placeholder="请输入内容" name="remarks"  lay-verify="remarks" id="remarks" class="layui-textarea" style="width:68.5%">${stock.remarks }</textarea>
			    </div>
			 </div>
