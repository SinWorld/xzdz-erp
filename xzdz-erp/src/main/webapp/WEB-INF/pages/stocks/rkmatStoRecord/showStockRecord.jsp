	...
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		...
		<div class="layui-form-item" style="margin-top: 5%">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="productName" lay-verify="productName" autocomplete="off" placeholder="材料名称" class="layui-input bj" style="width:76.5%" value="${record.materialName}" disabled="">
		    </div>
		</div>
		...
		<div class="layui-form-item">
		     <div class="layui-inline" style="top:9px;left: -80px;">
			      <label class="layui-form-label" style="width:150px;">入库数量</label>
		      ...
		      <div class="layui-inline" style="top:9px;left: -134px;">
			      <label class="layui-form-label" style="width:150px;">入库时间</label>
			      <div class="layui-input-inline">
