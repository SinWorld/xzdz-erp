...
layui.use(['table','form','layedit', 'laydate'], function(){
  ...
  table.render({
    elem: '#test'
    ,url:url+'clckStock/matckStockList.do'
    ,toolbar: '#toolbarDemo'
    ,title: '材料库存'
    ,cols: [[
       {field:'index', width:"8%", title: '序号', sort: true,type:'numbers'}
      ,{field:'materialName', width:"37%",align:'center', title: '材料名称'}
      ,{field:'stock', width:"30%", align:'center', title: '库位'}
      ,{field:'material', width:"25%", align:'center', title: '材料',hide:true}
  ...
  table.on('toolbar(test)', function(obj){
    ...
    if(obj.event=='getCheckData'){
		 layer.open({
	      		...
	      		resize:false,
	      	    anim: 1,
	      	  	content:[url+"clckStock/initCkMaterial.do",'yes']
	    	 });
