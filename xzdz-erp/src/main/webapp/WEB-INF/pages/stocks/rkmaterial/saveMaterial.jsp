...
<body style="width:100%;padding:0px; margin:0px;text-align: center;" onload="refreshAndClose()">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/matStock/saveMatStock.do"/>' method="post">
		...
		<input type="hidden" id="flag" value="${flag}">
		 	...
		 	<div class="layui-form-item" style="margin-top: 50px;">
				...
				<div class="layui-input-inline" style="width: 800px;text-align: left;">
					<select name="material" id="material" lay-filter="material" lay-verify="material" lay-search="">
						<option value="" selected="selected">请选择入库材料</option>
					</select>
				</div>
			</div>
			...
			<div class="layui-form-item">
					...
					<div class="layui-inline" style="top:9px;left:-79px;">
				     ...
				     <div class="layui-inline" style="top:9px;left: -200px;">
					      ...
					      <div class="layui-input-inline" style="width: 100px;">
					        <input type="text" name="rknumber" id="rknumber" lay-verify="rknumber" autocomplete="off" class="layui-input" style="width: 100px;" onchange="rkslxz()">
					      </div>
				     </div>
			 </div>
...
//ajax实现下拉项目带出项目的相关属性
	form.on('select(material)', function(data){
		//获得产品主键
		var raw_Material_Id=data.value;
		if(raw_Material_Id==""||raw_Material_Id==undefined){
			$('#scsl').val("");
			$('#yrksl').val("");
			return;
		}
		//ajax根据Id查询材料并设置其它属性值
		$.ajax({
			type : "post",
