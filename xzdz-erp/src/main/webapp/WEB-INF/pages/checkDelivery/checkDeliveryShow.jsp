	   ...
	   <div class="layui-tab-content">
		 ...
		 <div class="layui-form-item" style="margin-top: 3%;">
		    <div class="layui-inline" style="top:9px;">
		      ...
		      <div class="layui-inline" style="top:6px;left: 145px;">
			       <button type="button" class="layui-btn layui-btn-normal" id="shdck">查看送货单</button>
		 ...
		 <!--评审意见  -->
			...
			<!--流程图  -->
			<div class="layui-tab-item">
				<img style="position: absolute; top:155px; left:10%;width:90%;" id="lct" src=''>
			</div>
		</div>
  	</div>
	  <!-- 操作 Begin -->
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
  ...
  table.on('tool(test)', function(obj){
    ...
    //console.log(obj)
    if(obj.event === 'xz'){
    	var fp_Url="/checkDelivery/downLoad.do";
    	//权限验证
		 $.ajax({
	    		type : "post",
