						...
						<div class="layui-form-item">
						     <div class="layui-inline" style="top:9px;left: -29px;">
							      ...
							      <div class="layui-input-inline">
							        <input type="text"  autocomplete="off" class="layui-input" style="width: 280px;"  value="${our_Unit.unit_Name}">
							      </div>
						     </div>
						 ...
						 <div class="layui-form-item">
						      <div class="layui-inline" style="left: -29px;">
							      ...
							      <div class="layui-input-inline">
							        <input type="text"  autocomplete="off" class="layui-input bj" style="width: 280px;"  value="${customer.unit_Name}">
							      </div>
						     </div>
						      ...
						      <div class="layui-inline" style="left:210px;">
							      ...
							      <div class="layui-input-inline">
							        <input type="text"  autocomplete="off" class="layui-input" style="width: 280px;"  value="${qdrq}">
							      </div>
						    </div>
						 </div>
								  ...
								  <tbody>
								  	<c:forEach items="${orderList}" var="o">
								  		<tr>
								  			...
								  			<td>
								  			    <input type='text' class='form-control' aria-label='' aria-describedby='' disabled="" >
								  			</td>
								  			<td>
								  			    <input type='text' class='form-control' aria-label='' aria-describedby='' disabled="" >
								  			</td>
