...
<body style="width:100%;padding:0px; margin:0px;" onload="refreshAndClose()">
	<div style="width:625px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/cpjy/cpjy.do"/>' method="post" id="myForm">
			...
			<div class="layui-form-item" style="margin-top: 3%;margin-left:80px;">
			    ...
			    <div class="layui-input-block">
			      <input type="radio" name="out_come" value="新产品" title="新产品" lay-verify="result" >
			      <input type="radio" name="out_come" value="旧产品" title="旧产品" lay-verify="result">
			    </div>
			  </div>
