...
<body style="width:100%;padding:0px; margin:0px;" onload="refreshAndClose()">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/leadershipAuditProduct/leadershipAuditProduct.do"/>' method="post" id="myForm">
			...
			<input type="hidden" name="task_Id" id="taskId" value="${taskId}">
			 ...
			 <div class="layui-form-item layui-form-text" style="margin-top: 5%;">
		  		<label class="layui-form-label" style="width:160px;">不合格成品</label>
				  <div class="layui-input-block" style="left:-35px;">
					  	...
					  	<c:forEach items="${list}" var="l">
					  		<tr>
					  			...
					  			<td>
					  			    ...
					  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${l.product_Name}'>
					  			</td>
					  			<td>
					  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${l.specification_Type}'>
					  			</td>
					  			<td>
					  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${l.materielid}'>
					  			</td>
					  			<td>
					  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${l.unit}'>
					  			</td>
					  			<td>
					  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${l.numbers}'>
					  			</td>
					  			<td>
					  			    <input type='text' class='form-control bj' aria-label='' aria-describedby=''  disabled="" value='${l.materialQuality}'>
					  			</td>
					  		</tr>
					  	</c:forEach>
					  </tbody>
			...
			<div class="layui-form-item" style="margin-top: 3%;margin-left:20px;">
			    ...
			    <div class="layui-input-block">
			      ...
			      <input type="radio" name="out_come" value="返工" title="返工" lay-verify="result" >
