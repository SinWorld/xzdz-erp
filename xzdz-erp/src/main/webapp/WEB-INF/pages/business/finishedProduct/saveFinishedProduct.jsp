	...
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='' method="post" id="myForm">
		  ...
		  <div class="layui-form-item layui-form-text" style="margin-top: 5%;">
	  		<label class="layui-form-label" style="width:133px;">检验成品项</label>
				...
				<table class="table table-bordered" id="khlxrs" style="width: 100%">
				  <thead>
				    <tr>
				      ...
				      <th scope="col" style="text-align: center;width: 15%">成品名称</th>
				      ...
				      <th scope="col" style="text-align: center;width: 15%">成品质量</th>
				  	...
				  	<c:forEach items="${productList}" var="p">
				  		<tr>
				  			...
				  			<td>
				  			    ...
				  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${p.product_Name}'>
				  			</td>
				  			<td>
				  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${p.specification_Type}'>
				  			</td>
				  			<td>
				  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${p.materielid}'>
				  			</td>
				  			<td>
				  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${p.unit}'>
				  			</td>
				  			<td>
				  			    <input type='text' class='form-control bj' aria-label='' aria-describedby='' disabled="" value='${p.numbers}'>
				  			</td>
				  			<td>
				  			    <input type='text' class='form-control bj' aria-label='' aria-describedby=''  disabled="" value='${p.materialQuality}'>
				  			</td>
				  			<td>
							    <div class="layui-input-block" style="width:180px;margin-left: 10px;">
							      <input type="radio" name="jyjg.${p.product_Id}" value="合格" title="合格" checked="checked">
							      <input type="radio" name="jyjg.${p.product_Id}" value="不合格" title="不合格">
							    </div>
				  			</td>
				  		</tr>
				  	</c:forEach>
...
layui.use(['form', 'layedit', 'laydate'], function(){
	...
	function cljytable(){
		...
		for(var i=1;i<rows.length;i++){
			...
			//获得材料检验结果
			var cpjg;
			var cpjgs=$('input[name="jyjg.'+cpzj+'"]');
			for(var j=0;j<cpjgs.length;j++){
				if(cpjgs[j].checked){
					cpjg=cpjgs[j].value;
					break;
				}
	...
	function  saveSubmit(){
		...
		form.action=url+"finishedProduct/submit.do?task_Id="+taskId+"&out_come="+spjg+"&advice_="+spyj+"&data="+data;
		form.submit(); 
	}
</script>
</body>
