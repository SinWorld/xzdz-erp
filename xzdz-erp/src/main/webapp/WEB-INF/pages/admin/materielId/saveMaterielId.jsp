...
<body style="width:100%;padding:0px; margin:0px;" onload="refreshAndClose()">
	<div style="width:1100px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/materielId/saveMaterielId.do"/>' method="post">
		 ...
		 <div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block" style="left: -20px;">
		      <textarea placeholder="请输入内容" name="remarks"  lay-verify="remarks" id="remarks" class="layui-textarea" style="width:86.6%"></textarea>
		    </div>
		 </div>
		...
		<div class="layui-form-item" style="text-align: center;">
		    <div class="layui-input-block">
		      <button class="layui-btn" lay-submit="" lay-filter="demo1" style="width:25%;margin-top:10px;margin-left:-220px;">立即提交</button>
		    </div>
		</div>
	</form>
 </div>
