...
<body style="width:100%;padding:0px; margin:0px;text-align: center;" onload="refreshAndClose()">
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action="<c:url value="/company/saveCompany.do"/>" method="post">
		...
		<input type="hidden" id="flag" value="${flag}"> 
			 ...
			 <div class="layui-form-item" style="margin-top: 5%">
			    ...
			    <div class="layui-input-block">
			      <input type="text" name="unit_Name" lay-verify="unit_Name" autocomplete="off" placeholder="请输入单位名称" class="layui-input" style="width:81.3%" id="unit_Name">
			    </div>
			  </div>
		 ...
		 <div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block">
		      <textarea placeholder="请输入内容" name="remarks"  lay-verify="remarks" id="remarks" class="layui-textarea" style="width:81.6%"></textarea>
		    </div>
		 </div>
