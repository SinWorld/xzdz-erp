...
<body style="width:100%;padding:0px; margin:0px;"onload="refreshAndClose()">
	...
	<div style="width:1280px;height:auto;padding:0px; margin:0 auto;" id="main">
		<form class="layui-form" action='<c:url value="/materielIdProcess/saveMaterielIdProcess.do"/>' method="post"  enctype="multipart/form-data">
		 ...
		 <div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-block">
		      <textarea placeholder="请输入内容" name="sm"  lay-verify="sm" id="sm" class="layui-textarea" style="width:56.7%"></textarea>
		    </div>
		 </div>
